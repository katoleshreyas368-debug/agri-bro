...
import { MapPin, Calendar, Truck, CheckCircle, X, Search, Plus, Activity, Wind, Navigation, Package, Store, Phone, Mail, Clock, Wifi, WifiOff, CreditCard } from 'lucide-react';
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="bg-gradient-to-r from-blue-50 to-brand-green/5 p-5 rounded-2xl border border-blue-100/50">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Recipient Email</label>
                                        <div className="relative">
